...
/// <summary>
/// A view component for the Play button that toggles its appearance based on whether the game is paused.
/// </summary>
public class PlayButtonToggleView : MonoBehaviour
{
    [Header("View Colors")]
    /// <summary>
    /// Background color of the button when the game is not paused (i.e., active).
    /// </summary>
    [SerializeField] private Color normalButtonColor = Color.white;
    /// <summary>
    /// Background color of the button when the game is paused (i.e., inactive).
    /// </summary>
    ...
    public void Refresh()
    {
        bool isPlaying = !TimeManager.Instance.IsPaused;
        image.color = isPlaying ? activeButtonColor : normalButtonColor;
        icon.color = isPlaying ? Color.white : Color.black;
    }
}
